...
export default defineComponent({
  ...
  setup(props) {
    onMounted(async () => {
      ...
      // interfers with the component mount context. This mostly occurs when running a single test (from UI) that immediately render a dialog and rarely when running all tests at once.
