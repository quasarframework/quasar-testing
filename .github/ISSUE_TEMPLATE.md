...
Got a question?
===============
The issue list of this repo is **exclusively** for bug reports and feature requests. Please consider the fact that we cannot support you in the creation of your tests. For such issues regarding implementation, please use the following resources:

- Read the docs: http://quasar-framework.org
- For simple/quick questions ask in the Discord chat: https://discord.gg/5TDhbDg
