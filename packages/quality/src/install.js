    ...
    if (val === 'scripts') {
      api.extendPackageJson({
        scripts: {
          ...
          'audit:lighthouse':
            'lighthouse http://localhost:3000 view --output-path=./test/lighthouse/reports/index.html --config-path=./test/lighthouse/configs/full-config.js',
        },
      });
    }
  });
