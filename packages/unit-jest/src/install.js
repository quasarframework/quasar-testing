...
module.exports = function (api) {
  ...
  if (api.prompts.options.includes('SFC')) {
    api.render('./templates/loader');
  }

  // TODO: deprecate or remove?
  if (api.prompts.options.includes('wallabyjs')) {
    api.render('./templates/wallabyjs');
    const wallaby = require('./templates/wallabyjs/.package.json');
    extendPackageJson = __mergeDeep(extendPackageJson, wallaby);
  }

  // TODO: make default? Is this still maintained?
